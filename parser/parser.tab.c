...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_type_specifier = 24,            /* type_specifier  */
...
static const char *const yytname[] =
{
  ...
  "FLOAT", "INT", "IF", "ELSE", "WHILE", "RETURN", "PLUS", "MINUS", "MUL",
  "DIV", "ASSIGN", "SEMI", "LPAREN", "RPAREN", "LBRACE", "RBRACE",
  "$accept", "program", "declaration", "type_specifier", "expression",
...
{
      26,     1,   -11,   -11,    15,   -11,    14,     0,   -11,   -11,
      -8,   -11,   -11,     0,    11,    20,   -11,    -3,   -11,    -6,
       0,     0,   -11,     0,     0,    10,    13,   -11,    20,    20,
     -11,   -11,   -11,   -11
};
...
{
       0,     0,     9,     8,     0,     3,     0,     0,     1,     2,
       0,    18,    17,     0,     0,    12,    15,     0,     4,     0,
       0,     0,     7,     0,     0,     0,     0,    16,    10,    11,
      13,    14,     6,     5
};
...
{
      11,    12,    25,    11,    12,    20,    21,    17,    18,    19,
      28,    29,    27,    26,    13,     8,     7,    13,    10,     1,
       2,     3,    20,    21,    20,    21,    32,    22,     9,    33,
       1,     2,     3,    23,    24,    30,    31
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     3,     4,    11,    12,    15,    16,    13,
      20,    21,    18,    17,    17,     0,    15,    17,     4,     4,
       5,     6,    11,    12,    11,    12,    16,    16,     4,    16,
       4,     5,     6,    13,    14,    23,    24
};
...
{
       0,     4,     5,     6,    22,    23,    24,    15,     0,    23,
       4,     3,     4,    17,    25,    26,    27,    15,    16,    25,
      11,    12,    16,    13,    14,     5,    25,    18,    26,    26,
      27,    27,    16,    16
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* declaration: type_specifier ID SEMI  */
#line 36 "parser.y"
                                                         { printf("Declared variable: %s\n", (yyvsp[-1].sval)); }
#line 1103 "parser.tab.c"
    break;

  case 5: /* declaration: type_specifier ID ASSIGN expression SEMI  */
#line 37 "parser.y"
                                                         { printf("Assigned %s = %d\n", (yyvsp[-3].sval), (yyvsp[-1].ival)); }
#line 1109 "parser.tab.c"
    break;

  case 6: /* declaration: type_specifier ID ASSIGN FLOAT SEMI  */
#line 38 "parser.y"
                                                         { printf("Assigned %s = %s (float)\n", (yyvsp[-3].sval), (yyvsp[-1].sval)); }
#line 1115 "parser.tab.c"
    break;

  case 7: /* declaration: ID ASSIGN expression SEMI  */
#line 39 "parser.y"
                                                         { printf("Assigned %s = %d\n", (yyvsp[-3].sval), (yyvsp[-1].ival)); }
